...
use App\Mail\ReviseBudgetMail;
use Illuminate\Support\Facades\DB;


class ReviseBudgetController extends Controller
{
    public function mail(Request $request)
    {
        ...
        foreach ($email_addr as $email) {
            ...
            {
                Mail::to($sendToEmail)
                    ->send(new ReviseBudgetMail($dataEmail));
    ...
    public function changestatus($entity_cd='',$project_no='', $trx_type='', $doc_no='', $user_id='', $level_no='', $status='', $profile='', $flag='', $entity_name='', $logo='', $module='')
    {
        ...
        if(count($query)>0) {
            ...
            if($status == 'A') {
                ...
                return view('email/revisebudget/revision', $dataRevision);
            }
        }
    }
